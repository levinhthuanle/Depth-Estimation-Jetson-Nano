...
dataset = LoadStreams(sources="1", img_size=net_w, transforms=transform)
bs = len(dataset)
...
def function_2():
    for path, img, im0s, vid_cap, s in dataset:
        ...
        # r = requests.post('http://jetson.local:5000/update', json={'action': depth_act})
